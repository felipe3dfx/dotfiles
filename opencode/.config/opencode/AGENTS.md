...
- Never agree with user claims without verification. Say "vamos a verificar" and check code/docs first.
...
| Django models, views, ORM, DRF          | `~/.config/opencode/skills/django-expert/SKILL.md`        |
...
Use the `model` parameter when delegating to route each SDD phase to the appropriate model:

| Phase | Model | Rationale |
|-------|-------|-----------|
| `sdd-init` | `sonnet` | Bootstrap, low complexity |
| `sdd-explore` | `sonnet` | Fast codebase exploration |
| `sdd-propose` | `opus` | Proposal quality matters |
| `sdd-spec` | `opus` | Spec precision is critical |
| `sdd-design` | `opus` | Architecture decisions need the best |
| `sdd-tasks` | `sonnet` | Mechanical breakdown |
| `sdd-apply` | `sonnet` | Implementation, good balance |
| `sdd-verify` | `sonnet` | Validation |
| `sdd-archive` | `sonnet` | Artifact formatting |
