...
- Load and follow any relevant coding skills for the project stack (e.g., django-ninja, pytest, playwright, tailwind-4, htmx) if available in the user's skill set
